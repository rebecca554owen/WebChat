...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (toggleApiKeyBtn && apiKeyInput) {
        ...
        toggleApiKeyBtn.addEventListener('click', () => {
            ...
            // 使用模板来更新图标
            const iconTemplateId = isVisible ? 'eye-visible-template' : 'eye-hidden-template';
            const iconTemplate = document.getElementById(iconTemplateId);
            const iconClone = iconTemplate.content.cloneNode(true);
            
            // 清空按钮内容并添加新图标
            toggleApiKeyBtn.innerHTML = '';
            toggleApiKeyBtn.appendChild(iconClone);
        });
    }
